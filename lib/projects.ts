...
const projects: Projects = {
  devGram: {
    title: "News-App",
    description: [
      "This is a **news app** created with React.JS, where user can read any news as per particular choice and category. In this app user also gets various categories like General, Business, Entertainment, Health, Sports, Technology.",
      "Here, you'll get pure bais news.",
    ],
    images: {
      main: {
        link: "/project/newsApp/image.png",
        width: 1182,
        height: 732,
      },
    },
    ...
    links: {
      live: "https://newsninja.vercel.app",
      github: "https://github.com/SourabhKanade/react-news-app",
    },
  },
  ...
  //   links: {
  //     github: "https://github.com/SourabhKanade/covid-tracker-material-ui-react",
  ...
  //   links: {
  //     github: "https://github.com/SourabhKanade/connect-4-online-multiplayer",
  ...
  //   ],
  //   links: {
  //     github: "https://github.com/SourabhKanade/get-it-done",
  ...
  //   },
  //   links: {
  //     github: "https://github.com/SourabhKanade/url-shortener-ts-backend",
  ...
  //     github: "https://github.com/SourabhKanade/recipe-material-ui",
  //   },
  ...
  //     link: "https://github.com/SourabhKanade/pokemon/pulls?q=is%3Apr+is%3Aclosed",
  //   },
  //   title: "Pokemon",
  //   description: [
  ...
  //     github: "https://github.com/SourabhKanade/pokemon",
  //   },
  ...
  //     github: "https://github.com/SourabhKanade/Jokes-v2",
  //   },
  //   stack: [logos.react, logos.materialui],
  //   images: {
  //     main: {
